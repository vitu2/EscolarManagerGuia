...
function Finalidade() {
  return (
    <div>
      ...
      <p>
        <strong>O que é a finalidade:</strong> A finalidade seve para apontar
        sobre o que é aquela duplicata, na imagem vemos alguns exemplos como
      ...
      <p>
        ...
        fluxo para a geração do financeiro do aluno.
      </p>
    </div>
  );
}
