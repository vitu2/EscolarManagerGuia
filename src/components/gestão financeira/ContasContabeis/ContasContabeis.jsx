...
<p>
  Com isso pronto podemos passar para as proximas etapas, clicando em gestão
  financeira vamos ate Cadastros basicos Cadastro de Grupo Contabil
...
<figure>
  <img src="../../Assets/image/imagens/cc.png" />
  <p>
...
<figure>
  <img src="../../Assets/image/NewCC.png" />
  <figcaption>
    Nesta tela posso escolher o grupo que foi criado mais acima no cadastro
    de grupos de conta contabil depois de adicionarmos o grupo colocamos a
    descrição por exemplo: "recebimento matricula"
  </figcaption>
</figure>
...
<p>
  ...
  <strong
    >esta diferente dessa tela, não mostra o nome na versão web.</strong
  >
</p>
...
<a href="./Duplicatas.html">Duplicatas</a>
    </div>
  )
}
